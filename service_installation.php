...
<html>
  ...
  <body>  
		...
		<!-- HEADER
			================================================== -->	  
		<div class="visibled">
			<header style="background: url('img/Hero_Internet.png'); background-position:center 75px; background-size:100%; background-color:#000000; min-height:0; ">
				...
				<div class="row">
					<div class="col-md-12 packages rightline">
						<div class="gray" style="padding-top:13px;" onclick="$('#internet').animatescroll({padding:71});">
							<h1>XFINITY<sup>&reg;</sup> Internet</h1>
						</div>
				...
				<div class="wrapper">
					...
					<table border="0" cellpadding="0" cellspacing="0"">
    					...
    					<td class="price-heading">
    						<p><?php echo (!$esp ? "Price" : "Precio"); ?></p>
    					</td>
  					</tr>
  					<tr>
    					<td class="channel-name1">
    						<?php echo (!$esp ? "Blast!® Pro" : "Blast!® Pro"); ?>
    					</td>
    					<td class="price1" rowspan="2">
    						$79.95
    					</td>
  					</tr>
  					<tr class="hov">
    					<td colspan="2" class="desc">
    						<p><?php echo (!$esp ? "Download speeds up to 100 Mbps. Upload speeds up to 10 Mbps." : "Velocidades de descarga de hasta 100 Mbps. Velocidades de subir de hasta 10Mbps."); ?></p>
    					</td>
  					</tr>
  					<tr>
    					<td class="channel-name1">
    						<?php echo (!$esp ? "Extreme 150<sup>1</sup>" : "Extreme 150<sup>1</sup>"); ?>
    					</td>
    					<td class="price1" rowspan="2">
    						$89.95
    					</td>
						...
						<tr class="hov">
							<td colspan="2" class="desc">
								<p><?php echo (!$esp ? "Download speeds up to 150 Mbps. Upload speeds up to 25 Mbps." : "Velocidades de descarga de hasta 150 Mbps. Velocidades de subir de hasta 25 Mbps."); ?></p>
							</td>
  					</tr>
  					<tr>
    					<td class="channel-name1">
    						<?php echo (!$esp ? "Extreme 300<sup>1</sup>" : "Extreme 300<sup>1</sup>"); ?>
    					</td>
    					<td class="price1" rowspan="2">
    						$99.95
    					</td>
						...
						<tr class="hov">
							<td colspan="2" class="desc">
								<p><?php echo (!$esp ? "Download speeds up to 300 Mbps. Upload speeds up to 25 Mbps." : "Velocidades de descarga de hasta 300 Mbps. Velocidades de subir de hasta 25 Mbps."); ?></p>
							</td>
  					</tr>
						<tr>
							<td class="channel-name1">
								<?php echo (!$esp ? "1 Gig<sup>1</sup>" : "1 Gig<sup>1</sup>"); ?>
							</td>
							<td class="price1" rowspan="2">
								$139.95
							</td>
						...
						<tr class="hov">
							<td colspan="2" class="desc">
								<p><?php echo (!$esp ? "Download speeds up to 1 Gbps. Upload speeds up to 30 Mbps." : "Velocidades de descarga de hasta 1 Gbps. Velocidades de subir de hasta 30 Mbps."); ?></p>
							</td>
						</tr>
					</table>
				</div>

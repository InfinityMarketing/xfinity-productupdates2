...
<?php } ?>
	   ...
	   <!-- HEADER
	   ================================================== -->	  
	   <div class="visibled"><header style="background:transparent;height:0; min-height:0"></header></div>
	  
  <section id="voice" style="background-color:#eeeeee; padding:12px 0 1px 0;" class="bb"><h1><?php echo (!$esp ? "Discontinued Products and Services" : "Paquetes y Servicios Retirados"); ?></h1></section>
  <section id="double">
	<div class="container" style="padding:40px 0">
		<div class="wrapper">
			<h3 class="xf" style="margin-top:0;"><?php echo (!$esp ? "Double Plays" : "Paquete Dobles"); ?></h3>
			<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
  				<tr>
    				<td class="channel-name2 bb"><?php echo (!$esp ? "Internet Plus Double Play" : "Starter XF Paquete Doble"); ?></td>
  				</tr>
  				<tr>
    				<td class="channel-name2 bb"><?php echo (!$esp ? "Blast!® Plus Double Play" : "Preferred XF Paquete Doble"); ?></td>
  				</tr>
			</table>
		</div>
	</div>
  ...
  <section id="internet" style="background-color:#eeeeee;">
	<div class="container" style="padding:40px 0; background-color: #eeeeee;">
		<div class="wrapper">
			...
			<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
  				...
  				<tr>
    				<td class="channel-name2 bb">Performance</td>
  				</tr>
                <tr>
    				<td class="channel-name2 bb">Blast!®</td>
  				</tr>
                <tr>
    				<td class="channel-name2 bb">Extreme 150</td>
  				</tr>
                <tr>
